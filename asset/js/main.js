                                            ...
                                            if (result.isConfirmed) {
                                                Swal.fire({
                                                    ...
                                                    Swal.fire({
                                                        ...
                                                        $.playSound('asset/audio/Motionless_In_White_Voices_Synthwave_Edition_pWCBQ5ne3yY_140.mp3');
                                                        confetti.start();
                                                    })
                                                })
                                            } else {
                                                Swal.fire({
                                                    ...
                                                    Swal.fire({
                                                        ...
                                                        $.playSound('asset/audio/CJ_Whoopty_Biff_Remix_SLOWED_REVERB__IHlhc-1Pefw_140.mp3');
                                                    })
                                                })
                                            }
                                        })
